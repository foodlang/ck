...
TARGETDIR = sbin/Debug-linux-x86/ckmem
TARGET = $(TARGETDIR)/libckmem.a
OBJDIR = obj/Debug-linux-x86/ckmem
DEFINES += -D_DEBUG
...
TARGETDIR = sbin/Debug-linux-x86_64/ckmem
TARGET = $(TARGETDIR)/libckmem.a
OBJDIR = obj/Debug-linux-x86_64/ckmem
DEFINES += -D_DEBUG
...
TARGETDIR = sbin/Release-linux-x86/ckmem
TARGET = $(TARGETDIR)/libckmem.a
OBJDIR = obj/Release-linux-x86/ckmem
DEFINES +=
...
TARGETDIR = sbin/Release-linux-x86_64/ckmem
TARGET = $(TARGETDIR)/libckmem.a
OBJDIR = obj/Release-linux-x86_64/ckmem
DEFINES +=
...
$(OBJDIR)/Arena.o: ckmem/src/Arena.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/List.o: ckmem/src/List.c
	@echo "$(notdir $<)"
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
