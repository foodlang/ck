...
TARGETDIR = sbin/Debug-linux-x86/fflib
TARGET = $(TARGETDIR)/libfflib.a
OBJDIR = obj/Debug-linux-x86/fflib
DEFINES += -D_DEBUG
...
TARGETDIR = sbin/Debug-linux-x86_64/fflib
TARGET = $(TARGETDIR)/libfflib.a
OBJDIR = obj/Debug-linux-x86_64/fflib
DEFINES += -D_DEBUG
...
TARGETDIR = sbin/Release-linux-x86/fflib
TARGET = $(TARGETDIR)/libfflib.a
OBJDIR = obj/Release-linux-x86/fflib
DEFINES +=
...
TARGETDIR = sbin/Release-linux-x86_64/fflib
TARGET = $(TARGETDIR)/libfflib.a
OBJDIR = obj/Release-linux-x86_64/fflib
DEFINES +=
...
GENERATED += $(OBJDIR)/Struct.o
OBJECTS += $(OBJDIR)/Struct.o
...
$(OBJDIR)/Struct.o: fflib/src/Struct.c
	@echo "$(notdir $<)"
